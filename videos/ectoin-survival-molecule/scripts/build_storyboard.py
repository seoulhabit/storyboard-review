...
CHAPTERS = {  # scene id -> chapter title (payoff-named, not "Part 2")
    "01-hook": "A molecule invented by bacteria trying not to die",
    "08-humectant": "Why it is not just another hyaluronic acid",
    "12-load": "What it might actually do for skin",
    "16-trial104": "What the human evidence really says",
    "22-whofor": "How to read an ectoin label",
    "26-kbeauty": "Why K-beauty picked it up",
    "28-remember": "The verdict",
}
