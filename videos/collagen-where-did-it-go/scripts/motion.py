...
MOTION = {
    ...
    "04-demolition": {
        "treatments": ["sky warm", "ray draw", "beam cuts", "camera push"],
    ...
    "10-trials": {
        "treatments": ["ground inversion", "count-up 23", "outcome bands", "result meter"],
        "text": ["23", "randomised trials", "hydration", "elasticity", "wrinkles", "BENEFIT"],
        "copy": {"#ev-n": ("we", "trials", 1, 0.60)},
    },
    "11-caveat": {
    ...
    "13-uncertain": {
        ...
        "text": ["definitely works?", "definitely fails?", "UNCERTAIN"],
    },
    "14-hierarchy": {
    ...
    "15-verdict": {
        "treatments": ["optional divider", "final wash", "bricks exit"],
