...
364 words · 161.1 wpm overall · tempo 1.08 · first word at 0.10s · runtime 2:20.83 (140.834s).
...
## 02 · `02-promise` — 0:05.26 → 0:14.64 (9.38s · in: iris · file `02-promise`)
...
*30 words · first word 0:05.56 · last word 0:14.59*  
...
*25 words · first word 0:20.84 · last word 0:29.93*  
...
## 05 · `05-boundary` — 0:30.23 → 0:38.68 (8.45s · in: phase · file `03-building`)
...
*22 words · first word 0:30.23 · last word 0:38.63*  
**On screen:** preserve > replace  
**Motion:** camera pull-back, shield draw, ghost repair fails, preserve pulse  

## 06 · `06-door` — 0:38.68 → 0:49.00 (10.32s · in: iris · file `06-door`)
...
*31 words · first word 0:38.98 · last word 0:48.70*  
...
## 07 · `07-film` — 0:49.00 → 0:56.90 (7.90s · in: phase · file `06-door`)
...
*38 words · first word 1:05.28 · last word 1:18.02*  
...
## 10 · `10-trials` — 1:18.12 → 1:26.34 (8.22s · in: invert · file `10-evidence`)

> Does the powder work? Trials do report modest improvements in hydration, elasticity, or wrinkles.

*14 words · first word 1:18.57 · last word 1:26.04*  
...
## 11 · `11-caveat` — 1:26.34 → 1:29.92 (3.58s · in: phase · file `10-evidence`)

> But many were small, short, and industry funded.

*8 words · first word 1:26.34 · last word 1:29.62*  
**On screen:** small · short · industry funded  
**Motion:** head dim wash, tag shrink, industry recolour  
**Claims:** C7  

## 12 · `12-filter` — 1:29.92 → 1:44.79 (14.88s · in: phase · file `10-evidence`)
...
*41 words · first word 1:29.92 · last word 1:44.49*  
...
## 13 · `13-uncertain` — 1:44.79 → 1:52.58 (7.78s · in: phase · file `10-evidence`)
...
*21 words · first word 1:44.79 · last word 1:52.48*  
**On screen:** works? · fails? · UNCERTAIN  
**Motion:** question strikes, flood retract, meter settles  
**Claims:** C7  

## 14 · `14-hierarchy` — 1:52.58 → 2:08.91 (16.33s · in: invert · file `14-hierarchy`)
...
*34 words · first word 1:53.03 · last word 2:08.60*  
...
## 15 · `15-verdict` — 2:08.91 → 2:15.83 (6.93s · in: phase · file `14-hierarchy`)
