...
style = """
  ...
  .ribbon { position:absolute; top:14%; width:220px; font-family:var(--font-mono); font-size:22px;
    line-height:1.9; color:rgba(247,245,240,0.35); opacity:0; text-align:left;
    writing-mode:vertical-rl; height:52%; }
...
body = f'''
    <div class="bench">
      ...
      <div class="ribbon left" id="s01-ribbon-l">CENTELLA ASIATICA EXTRACT · WATER · GLYCERIN · NIACINAMIDE · PANTHENOL · SODIUM HYALURONATE · ALLANTOIN · FRAGRANCE</div>
      <div class="ribbon right" id="s01-ribbon-r">CENTELLA ASIATICA EXTRACT · WATER · BUTYLENE GLYCOL · NIACINAMIDE · MADECASSOSIDE · PANTHENOL · ALLANTOIN · FRAGRANCE</div>
...
script = f"""
  ...
  gsap.set('#s03-bottles', {{ opacity: 0.9 }});
