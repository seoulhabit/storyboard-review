...
def main():
    n = 0
    # This project names takes NN-<speaker>.wav, not NN.wav: it runs two
    # voices, so a take is identified by line AND speaker. The inherited
    # "[0-9][0-9].wav" pattern matched nothing here and reported "0 takes
    # normalised" as though the job were done.
