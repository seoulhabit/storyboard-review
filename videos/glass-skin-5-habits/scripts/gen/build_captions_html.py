    ...
    <template>
      <style>
        ...
        /*
          ...
          Position (QC #1, BLOCKER, 2026-08-30): was top:1360px, squarely inside
          YouTube Shorts' bottom ~20% UI overlay zone (channel handle, description,
          audio-track pill) -- confirmed against a real render. Moved up 400px into
          the middle third of the 9:16 frame (960-1110 of 1920), which forced a
          same-day reflow of every scene's own content that collided with the new
          band -- see build_frames.py's per-frame comments for what moved.
        */
        #root {{
        ...
        .caption-stage {{ position: absolute; left: 0; right: 0; top: 960px; height: 150px;
